        ...
        <div className="row justify-content-center align-items-center py-5">
          <div className="col-md-6">
            <div className="card bg-primary-color text-white p-3 p-md-5 mb-5 rounded">
              <h2 className="pb-4">¡Contáctanos y se parte de esta increíble historia junto a nosotros!</h2>
              <p>
                Si tienes algo que contar con nosotros acerca de bienestar, innovación y
                {' '}
                cultura contemporánea para alcanzar la felicidad desde la diversidad, el
                {' '}
                entusiasmo y la inclusión(DEI)
              </p>
              <ul className="pt-4">
                <li className="py-3">
