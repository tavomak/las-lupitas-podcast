...
const Modal = ({ children, onClick, showModal, size, bgColor, noPadding }: Props) => (
  <CSSTransition in={showModal} timeout={300} classNames='alert' unmountOnExit>
    <div className={`${styles.modal}`} data-testid='modal'>
      ...
      >
        ...
        <div className={`modal-body ${noPadding ? 'p-0' : ''}`}>{children}</div>
      </div>
    </div>
  </CSSTransition>
);
